      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="fade-in opacity-0 translate-y-8 transition-all duration-1000 text-4xl font-bold mb-4 bg-gradient-to-r from-blue-700 to-sky-600 bg-clip-text text-transparent">
              Notre Philosophie
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {methodology.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="fade-in opacity-0 translate-y-8 transition-all duration-1000 bg-gradient-to-br from-blue-50 to-sky-50/50 rounded-xl p-6 border border-blue-200/50 hover:shadow-xl hover:shadow-blue-500/20 hover:-translate-y-2 transition-all duration-500"
                  style={{ transitionDelay: `${index * 100}ms` }}
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-sky-600 rounded-lg flex items-center justify-center mb-4 shadow-lg">
                  ...
                  <div className={`${isEven ? '' : 'lg:order-2'}`}>
                    <div className="sticky top-24">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-sky-600 rounded-xl flex items-center justify-center shadow-lg">
                      ...
                      <div className="inline-flex items-center gap-2 bg-gradient-to-br from-blue-50 to-sky-50/50 px-4 py-2 rounded-full border border-blue-200/50 mb-6">
                      ...
                      <div className="bg-white rounded-xl p-6 border border-blue-200/50 shadow-lg">
                  ...
                  <div className={`${isEven ? 'lg:order-2' : 'lg:order-1'} space-y-4`}>
                    {phase.activities.map((activity, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className="bg-white rounded-xl p-6 shadow-xl border border-blue-200/50 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500"
                        >
                          <div className="flex items-start gap-4">
                            <div className="w-10 h-10 bg-gradient-to-br from-blue-100 to-sky-100 rounded-lg flex items-center justify-center flex-shrink-0">
