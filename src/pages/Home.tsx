    ...
    <div ref={pageRef}>
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        {slides.map((slide, index) => (
          ...
          >
            <Image
              ...
              priority={index === 0}
            />
            <div className="absolute inset-0 bg-gradient-to-br from-blue-900/60 via-sky-900/50 to-blue-800/60"></div>
            <div className="absolute inset-0 overflow-hidden">
              <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-br from-blue-400/10 to-sky-500/10 rounded-full blur-3xl animate-float"></div>
              <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-br from-cyan-400/10 to-blue-500/10 rounded-full blur-3xl animate-float-delayed"></div>
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-blue-500/5 to-sky-500/5 rounded-full blur-3xl animate-pulse-slow"></div>
            </div>
          </div>
        ))}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/90 backdrop-blur-sm rounded-full shadow-lg mb-8 border border-blue-200/50">
              <Sparkles className="w-4 h-4 text-blue-600" />
              <span className="text-sm font-medium text-blue-800">{slides[currentSlide].badge}</span>
            </div>
          </div>

          <h1
            key={`title-${currentSlide}`}
            className="fade-in opacity-0 translate-y-8 transition-all duration-1000 delay-200 animate-in text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-cyan-300 via-sky-400 to-blue-500 bg-clip-text text-transparent leading-relaxed pb-4 drop-shadow-2xl"
          ...
          >
            <Link
              ...
              className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-sky-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl hover:shadow-blue-500/50 hover:scale-105 transition-all duration-300 flex items-center gap-2"
            >
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="fade-in opacity-0 translate-y-8 transition-all duration-1000 text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-blue-700 to-sky-600 bg-clip-text text-transparent">
              Nos Services
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {services.map((service, index) => {
              ...
              return (
                <div
                  key={index}
                  className="fade-in opacity-0 translate-y-8 transition-all duration-1000 group relative bg-gradient-to-br from-blue-50 to-sky-50/50 rounded-2xl p-8 border border-blue-200/50 hover:border-blue-400/50 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-2 transition-all duration-500"
                  style={{ transitionDelay: `${(index + 1) * 200}ms` }}
                >
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-sky-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-lg">
          ...
          <div className="fade-in opacity-0 translate-y-8 transition-all duration-1000 delay-800 text-center">
            <Link
              href="/services"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-sky-600 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-blue-500/50 hover:scale-105 transition-all duration-300"
            >
              En savoir plus
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 mb-12">
            {processSteps.map((step, index) => {
              ...
              return (
                ...
                >
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-sky-600 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg">
                    <Icon className="w-8 h-8 text-white" />
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {projects.map((project, index) => (
              <div
                ...
                style={{ transitionDelay: `${(index + 1) * 200}ms` }}
              >
                <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-blue-200/50 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-2 transition-all duration-500">
                  <div className="relative overflow-hidden h-48">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-blue-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end justify-center pb-4">
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-sky-600 to-blue-700"></div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="fade-in opacity-0 translate-y-8 transition-all duration-1000 delay-200 text-xl text-blue-50 mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <Link
            href="/contact"
            className="fade-in opacity-0 translate-y-8 transition-all duration-1000 delay-400 inline-flex items-center gap-3 px-10 py-5 bg-white text-blue-700 rounded-xl font-bold text-lg shadow-2xl hover:shadow-3xl hover:scale-105 hover:bg-blue-50 transition-all duration-300"
          >
