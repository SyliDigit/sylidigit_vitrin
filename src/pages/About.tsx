    ...
    <div ref={pageRef} className="min-h-screen">
      <section className="relative py-32 bg-gradient-to-br from-blue-50 via-sky-50/30 to-cyan-50/20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <h1 className="fade-in opacity-0 translate-y-8 transition-all duration-1000 text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-700 via-sky-600 to-blue-500 bg-clip-text text-transparent leading-relaxed pb-4">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="fade-in opacity-0 translate-y-8 transition-all duration-1000 text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-700 to-sky-600 bg-clip-text text-transparent">
                Qui Sommes-Nous ?
              </h2>
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p className="fade-in opacity-0 translate-y-8 transition-all duration-1000 delay-200">
                  <span className="font-bold text-blue-700">SyliDigit</span> est une entreprise de développement digital basée en Guinée, spécialisée dans la création de solutions technologiques innovantes adaptées au contexte africain.
                </p>
              ...
              <div className="fade-in opacity-0 translate-y-8 transition-all duration-1000 delay-500 mt-8 flex items-start gap-4 p-6 bg-gradient-to-br from-blue-50 to-sky-50/50 rounded-xl border border-blue-200/50">
            ...
            <div className="space-y-6">
              <div className="fade-in opacity-0 translate-y-8 transition-all duration-1000 delay-600 bg-white rounded-2xl p-8 shadow-xl border border-blue-200/50 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-sky-600 rounded-xl flex items-center justify-center mb-6 shadow-lg">
              ...
              <div className="fade-in opacity-0 translate-y-8 transition-all duration-1000 delay-700 bg-white rounded-2xl p-8 shadow-xl border border-blue-200/50 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-sky-600 rounded-xl flex items-center justify-center mb-6 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => {
              ...
              return (
                <div
                  key={index}
                  className="fade-in opacity-0 translate-y-8 transition-all duration-1000 bg-white rounded-xl p-8 border border-blue-200/50 hover:shadow-xl hover:shadow-blue-500/20 hover:-translate-y-2 transition-all duration-500"
                  style={{ transitionDelay: `${(index + 1) * 150}ms` }}
                >
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-sky-600 rounded-xl flex items-center justify-center mb-4 mx-auto shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="fade-in opacity-0 translate-y-8 transition-all duration-1000 text-center bg-gradient-to-br from-blue-50 to-sky-50/50 rounded-xl p-8 border border-blue-200/50 hover:shadow-xl hover:shadow-blue-500/20 hover:-translate-y-2 transition-all duration-500"
                style={{ transitionDelay: `${(index + 1) * 150}ms` }}
              >
            ...
            {reasons.map((reason, index) => {
              ...
              return (
                <div
                  ...
                  style={{ transitionDelay: `${(index + 1) * 150}ms` }}
                >
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-sky-600 rounded-xl flex items-center justify-center mb-4 shadow-lg">
                    <Icon className="w-7 h-7 text-white" />
                  </div>
