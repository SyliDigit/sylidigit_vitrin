                ...
                >
                  <div className={isEven ? '' : 'lg:col-start-2'}>
                    <div className="sticky top-24">
                      ...
                      <div className="bg-gradient-to-br from-green-50 to-emerald-50/50 rounded-xl p-6 border border-green-200/50 mb-8">
                  ...
                  <div className={isEven ? 'lg:col-start-2' : 'lg:col-start-1 lg:row-start-1'}>
                    <div className="bg-white rounded-2xl p-8 shadow-xl border border-green-200/50 hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-500 mb-6">
