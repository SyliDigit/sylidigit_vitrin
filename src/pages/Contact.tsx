      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h2 className="fade-in opacity-0 translate-y-8 transition-all duration-1000 text-3xl md:text-4xl font-bold mb-8 bg-gradient-to-r from-blue-700 to-sky-600 bg-clip-text text-transparent">
                Nos Coordonnées
              </h2>
                ...
                {contactInfo.map((info, index) => {
                  ...
                  return (
                    <a
                      key={index}
                      href={info.link}
                      className="fade-in opacity-0 translate-y-8 transition-all duration-1000 flex items-start gap-4 p-6 bg-gradient-to-br from-blue-50 to-sky-50/50 rounded-xl border border-blue-200/50 hover:shadow-lg hover:shadow-blue-500/20 hover:-translate-y-1 transition-all duration-300"
                      style={{ transitionDelay: `${(index + 1) * 150}ms` }}
                    >
                      <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-sky-600 rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="fade-in opacity-0 translate-y-8 transition-all duration-1000 delay-600 w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-sky-600 text-white font-bold text-lg rounded-lg shadow-lg hover:shadow-xl hover:from-blue-700 hover:to-sky-700 hover:-translate-y-1 transition-all duration-300"
                >
                  Envoyer le message
                </button>
              </form>
