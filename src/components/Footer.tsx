...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-gradient-to-br from-blue-900 via-sky-900 to-blue-950 text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div>
            <Image
              src="/logo_syli_blanc_sans_bg.png"
              alt="SyliDigit"
              width={64}
              height={64}
            ...
            <ul className="space-y-2">
              <li>
                <button
                  ...
                  className="text-blue-200 hover:text-white hover:translate-x-1 transition-all duration-300 inline-block"
                >
                  Nos Services
                </button>
              </li>
        ...
        <div className="border-t border-blue-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-blue-800 hover:bg-blue-700 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
                aria-label="Facebook"
              >
